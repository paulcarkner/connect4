/*! For license information please see main.476b2e1b.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
            ...
            if (0 === (7 & n)) {
              ...
              b &&
                ...
                0 < (y = Qr(r, b)).length &&
                  ...
                  g ? (b.data = g) : null !== (g = Vt(t)) && (b.data = g))),
                (g = It
                  ? (function (e, n) {
                      switch (e) {
                        case "compositionend":
        ...
        function Ya(e) {
          ...
          function v(l, u, i, s) {
            ...
            for (
              var f = (c = null), h = u, v = (u = 0), y = null, g = i.next();
              null !== h && !g.done;
              v++, g = i.next()
            ) {
  ...
  !(function () {
    ...
    var p = "App_App__YwCtg",
      m = "App_Dialog__MnWRb",
      h = "Board_boardContainer__xft6I",
      v = "Board_board__TniFM",
      y = "Column_column__Lw3BY",
      g = "Cell_cell__kPXRx",
      b = "Cell_red__OW32L",
      k = "Cell_black__W-Y5U",
      w = t(184),
          ...
          u(t, [
            {
              ...
              value: function () {
                return (0, w.jsx)("div", {
                  className: ""
                    .concat(g, " ")
                    .concat(1 === this.props.cellValue ? b : null, " ")
                    .concat(2 === this.props.cellValue ? k : null),
                  style: {
                    "--xShift": 1 * (3 - this.props.columnIndex) + "%",
                    "--yShift": 1 * (2.5 - this.props.cellIndex) + "%",
                  },
                });
              },
            },
          ...
          u(t, [
            {
              ...
              value: function () {
                ...
                return (0, w.jsx)("button", {
                  ...
                  "data-column-id": this.props.columnIndex,
                  children: this.props.columnLayout.map(function (n, t) {
                    return (0,
                    w.jsx)(S, { columnIndex: e.props.columnIndex, cellIndex: t, cellValue: n }, t);
                  }),
                });
              },
            },
              ...
              value: function () {
                ...
                return (0, w.jsx)("div", {
                  ...
                  children: (0, w.jsx)("div", {
                    className: v,
                    style: { "--player-color": this.props.playerColor },
                    children: this.props.boardLayout.map(function (n, t) {
                      return (0,
                      w.jsx)(x, { columnIndex: t, columnLayout: e.props.boardLayout[t], clickHandler: e.props.clickHandler }, t);
                    }),
                  }),
                });
              },
        ...
        function t(e) {
          ...
          return (
            ...
            ((l = n.call(this, e)).state = {
              board: new Array(7).fill(null).map(function () {
            ...
            (l.handleClick = function (e) {
              for (
                ...
                if (null === t[n][r]) {
                  (t[n][r] = l.state.isPlayer1 ? 1 : 2),
                    l.setState(
                      { board: t, isPlayer1: !l.state.isPlayer1 },
                      function () {
                        return l.checkWinner();
                      }
                    );
                  break;
                }
            }),
            (l.checkWinner = function () {
              for (var e = null, n = 0, t = 0; t < 7; t++) {
                for (var r = 0; r < 6; r++)
                  if (
                    (l.state.board[t][r] !== e && (n = 0),
                    n++,
                    (e = l.state.board[t][r]),
                    4 === n && null !== e)
                  )
                    return void l.setState({ winner: e });
                e = null;
              }
              for (var a = 0; a < 6; a++) {
                for (var o = 0; o < 7; o++)
                  if (
                    (l.state.board[o][a] !== e && (n = 0),
                    n++,
                    (e = l.state.board[o][a]),
                    4 === n && null !== e)
                  )
              ...
              for (var u = 3; u < 7; u++)
                for (var i = 0; i < 3; i++)
                  if (
                    l.state.board[u][i] === l.state.board[u - 1][i + 1] &&
                    l.state.board[u][i] === l.state.board[u - 2][i + 2] &&
                    l.state.board[u][i] === l.state.board[u - 3][i + 3] &&
                    null !== l.state.board[u][i]
                  )
                    return void l.setState({ winner: l.state.board[u][i] });
              for (var s = 0; s < 4; s++)
                for (var c = 0; c < 3; c++)
                  if (
                    l.state.board[s][c] === l.state.board[s + 1][c + 1] &&
                    l.state.board[s][c] === l.state.board[s + 2][c + 2] &&
                    l.state.board[s][c] === l.state.board[s + 3][c + 3] &&
                    null !== l.state.board[s][c]
                  )
                    return void l.setState({ winner: l.state.board[s][c] });
            }),
            (l.reload = function () {
    ...
    n.s(document.getElementById("root")).render(
      (0, w.jsx)(e.StrictMode, { children: (0, w.jsx)(_, {}) })
    );
  })();
})();
//# sourceMappingURL=main.476b2e1b.js.map
